...
<div id="list">
    <ul class="ul">
        ...
        <li class="text">
            상품 관리
            <ul>
            	<li><a href="${contextPath}/admin/enrollGrape">포도 품종 추가</a></li>
        ...
        <li class="text">
            ...
            <ul>
                ...
                <li><a href="<c:url value='/admin/infoEnroll'/>">정보글 등록(X)</a></li>
            </ul>
        </li>
        ...
        <li class="service">
            고객센터 관리
            <ul>
                <li><a href="<c:url value='/admin/notice'/>">공지 사항</a></li>
