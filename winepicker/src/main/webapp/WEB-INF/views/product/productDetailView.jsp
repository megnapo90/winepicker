   ...
   <div class="products-container">
        ...
        <div class="product">
            <div class="product-image">
                <img src="${contextPath}/resources/images/product/${wine.wineImage.changeName}" alt="${wine.wineName} 이미지">
        ...
        <img src="${contextPath}/resources/css/images/product/type/type${wine.grape.wineTypeNo}.svg" alt="${wine.wineType.wineTypeName}">
