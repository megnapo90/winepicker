		...
		<div class="my-review">
            ...
            <div class="review-insert-container">
                ...
                <div class="review-insert-form"> 
                	<form action="${contextPath}/user/review/update/${review.orderNo}" id="enrollForm" method="post" >
                    <div class="review-insert">
                        <div class="review-title">
                            <p>한줄평</p>
                            <input type="text" id="title" name="reveiwContent" value="${review.content }" >
                        </div>
                        <div class="review-content">
                            <p>별점</p>
	                        <input type="range" min="0.0" max="5.0" id="point" name="reveiwPoint" value="${review.point }">
	                        <p>입력받은 별점 값... 받아야 해.............</p>
                        </div>
                    </div>
